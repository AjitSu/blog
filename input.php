                  ...
                  <div class="panel-body">
                      <div class="row">
                        ...
                        <br>
                            ...
                            <div class="col-md-8">
                                <input type="file" class="form-control" name="uploadmain"><br>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-2">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control" rows="6" name="main"></textarea>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control" rows="15" name="blogdata" id="comment"></textarea>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="submit" name="image_upload" id="submit"class="btn btn-success" value="upload image">
                            </div>
                        </div>
                      </div>
                  </div>
    ...
    if(isset($_POST['image_upload']))
            {
                ...
                $sql="INSERT INTO demo(id,Title,image,maindata,data) VALUES('','".$blogname."','".$mainimage."','".$maindata."','".$data."')";
