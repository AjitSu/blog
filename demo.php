<html>
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="#popUpWindow" data-toggle="modal">Login</a></li>
      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <form role="form">
            <div class="form-group">
              <input type="text" class="form-control" name="user" placeholder="Email"/><br><br>
        ...
        if(isset($_POST['submit']))
        {
            ...
            else
            {
                ...
                echo "<script>alert('Please insert correct input')</script>";
        	...
        	<div class="row">
                <div class="col-md-4">
                    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel" height="200px">
                        ...
                        {
                        ?>
                        <p style="text-align: justify;font-family: Cambria;font-size:18px;">&ensp;<i class="fas fa-circle-notch fa-spin"></i> <b><a href="blogs.php?id=<?php echo $row['id']?>"><?php echo $rows['Title']?></a></b></p>
                        <?php
                    }
                    ?>
                </div>
...
<div align="center">
  <?php  
        ...
        for ($i=1; $i<=$total_pages; $i++) {  
                     $pagLink .= "<li><a href='d1.php?page=".$i."'>".$i."</a></li>";  
        };  
        echo $pagLink . "</ul></nav>";  
        ?>
</div>
